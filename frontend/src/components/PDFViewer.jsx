...
// Renders a single PDF on-demand (never preloaded/batched) page-by-page as canvas,
// scaled to the screen width exactly — matches the native "Files app" preview look.
// Falls back to the plain native iframe if anything goes wrong or takes too long.
